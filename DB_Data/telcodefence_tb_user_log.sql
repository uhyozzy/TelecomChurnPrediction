...
CREATE TABLE `tb_user_log` (
  ...
  `Churn_Value` tinyint(1) DEFAULT '0',
  `CLTV` bigint DEFAULT NULL,
  KEY `FK_tb_user_TO_tb_user_log_1` (`Customer_ID`),
  CONSTRAINT `FK_tb_user_TO_tb_user_log_1` FOREIGN KEY (`Customer_ID`) REFERENCES `tb_user` (`Customer_ID`) ON DELETE CASCADE
